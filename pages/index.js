        ...
        <div className="flex flex-row bg-[#00C39A] rounded-md w-full h-52 mb-6">
          ...
          <div name="first-hour-progress" className="p-4 basis-1/4 relative flex flex-col items-center">
            <motion.svg variants={svgVariants} initial="hidden" animate="visible" width="172" height="172" viewBox="0 0 172 172" fill="none" xmlns="http://www.w3.org/2000/svg">i
              ...
              <motion.path variants={yellowVariants}  d="M86 157C125.212 157 157 125.212 157 86C157 46.7878 125.212 15 86 15C46.7878 15 15 46.7878 15 86C15 125.212 46.7878 157 86 157Z" stroke="#FFD155" stroke-width="16" shape-rendering="crispEdges"/>
              </g>
              <g filter="url(#filter2_i_35_32)">
              <motion.path variants={yellowVariants}  d="M86.5 145C118.809 145 145 118.809 145 86.5C145 54.1913 118.809 28 86.5 28C54.1913 28 28 54.1913 28 86.5C28 118.809 54.1913 145 86.5 145Z" stroke="#FBB907" stroke-width="13"/>
              </g>
              <defs>
          ...
          <div name="task-progress" className="p-4 basis-1/4 relative flex flex-col items-center">
            <motion.svg variants={svgVariants} initial="hidden" animate="visible" width="172" height="172" viewBox="0 0 172 172" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <motion.path variants={pinkVariants} d="M86 157C125.212 157 157 125.212 157 86C157 46.7878 125.212 15 86 15C46.7878 15 15 46.7878 15 86C15 125.212 46.7878 157 86 157Z" stroke="#FFA5AA" stroke-width="16" shape-rendering="crispEdges"/>
              </g>
              <g filter="url(#filter2_i_35_37)">
              <motion.path variants={pinkVariants} d="M86.5 145C118.809 145 145 118.809 145 86.5C145 54.1913 118.809 28 86.5 28C54.1913 28 28 54.1913 28 86.5C28 118.809 54.1913 145 86.5 145Z" stroke="#FB8087" stroke-width="13"/>
              </g>
              <defs>
